...
class LatentEncoder(nn.Module):
    ...
    """
    def __init__(self, num_hidden, num_latent, input_dim, task_type='1d'):
...
class Decoder(nn.Module):
    ...
    """
    def __init__(self, num_hidden, input_dim): # input_dim is 1 less than input_dim from the other Encoders
