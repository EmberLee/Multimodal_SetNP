from models.Dupont.module import *
import pdb
...
class NeuralProcess(nn.Module):
    ...
    def forward(self, x_context, y_context, x_target, y_target=None):
        ...
        if self.training:
            ...
            return p_y_pred, y_pred_mu, y_pred_sigma, q_target, q_context
        else:
            ...
            y_pred_mu, y_pred_sigma = self.xz_to_y(x_target, z_sample) # decoder
            p_y_pred = Normal(y_pred_mu, y_pred_sigma) # dist in original code
